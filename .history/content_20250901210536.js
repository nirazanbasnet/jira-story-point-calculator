...
class JIRAStoryPointCalculator {
    ...
    extractJIRAComplexity() {
        ...
        console.log('JIRA Story Point Calculator: Looking for complexity in field headings...');
        const complexityHeading = this.findElementByText('Complexity', 'h3');
        if (complexityHeading) {
            console.log('JIRA Story Point Calculator: Found complexity heading:', complexityHeading);
            const parentContainer = complexityHeading.closest('[data-testid*="customfield"]');
            if (parentContainer) {
                console.log('JIRA Story Point Calculator: Found parent container:', parentContainer);
