...
// Add global functions for debugging and control
...
// Add keyboard shortcut (Ctrl+Shift+S) to toggle panel
...
console.log('- Keyboard shortcut: Ctrl+Shift+S to toggle panel');
