...
class JIRAStoryPointCalculator {
    ...
    activate() {
        console.log('JIRA Story Point Calculator: Activating extension...');

        if (this.isActive) {
            console.log('JIRA Story Point Calculator: Extension already active');
            return;
        }
    ...
    createFloatingPanel() {
        ...
        this.floatingPanel.querySelector('.minimize-btn').addEventListener('click', () => {
            console.log('JIRA Story Point Calculator: Minimize button clicked');
    ...
    togglePanelMinimized() {
        if (this.floatingPanel) {
            ...
            if (this.floatingPanel.classList.contains('minimized')) {
    ...
    addPanelStyles() {
        ...
        style.textContent = `
            ...
            /* Minimized state */
            #jira-story-point-calculator-panel.minimized {
                min-width: 80px !important;
                max-width: 80px !important;
            }

            #jira-story-point-calculator-panel.minimized .status-text {
                display: none !important;
            }

            #jira-story-point-calculator-panel.minimized .minimize-btn {
                display: none !important;
            }
        `;
        document.head.appendChild(style);
