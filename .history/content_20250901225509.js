...
class JIRAStoryPointCalculator {
    ...
    showInfoTooltip() {
        ...
        tooltip.className = 'jira-story-point-info-tooltip';
        tooltip.innerHTML = `
            ...
            <div class="tooltip-content">
                <div class="info-section">
                    <h4><span class="tooltip-icon">🎯</span> Status</h4>
                    <div class="value-row">
                        <span class="label">Status:</span>
                        <span class="value has-value">Active & Monitoring</span>
                    </div>
                </div>
                <div class="info-section">
                    <h4><span class="tooltip-icon">🧮</span> Formula</h4>
                    <div class="formula">√(Time × Complexity)</div>
                    <div class="example">Example: Time = 2h, Complexity = 0.5 → TW = √(2 × 0.5) = √1 = 1</div>
                </div>
                <div class="info-section">
                    <h4><span class="tooltip-icon">⚡</span> Updates</h4>
                    <div class="value-row">
                        <span class="label">Updates:</span>
                        <span class="value has-value">Automatic</span>
                    </div>
                </div>
                <div class="info-section">
                    <h4><span class="tooltip-icon">🎨</span> Panel</h4>
                    <div class="value-row">
                        <span class="label">Panel:</span>
                        <span class="value has-value">Draggable</span>
                    </div>
                </div>
                <div class="info-section">
                    <h4><span class="tooltip-icon">🔑</span> Shortcuts</h4>
                ...
                <div class="info-section">
                    <h4><span class="tooltip-icon">💡</span> Features</h4>
                    <ul class="features-list">
                        <li><span class="tooltip-icon">✅</span> Automatic updates</li>
                        <li><span class="tooltip-icon">✅</span> Floating panel</li>
                        <li><span class="tooltip-icon">✅</span> Draggable panel</li>
                        <li><span class="tooltip-icon">✅</span> Info tooltip</li>
                        <li><span class="tooltip-icon">✅</span> Keyboard shortcuts</li>
                    </ul>
                </div>
            </div>
        `;
